...
export const EventsPool: GameEvent[] = [
  ...
  },
  {
    ...
    category: 'economy',
    baseSeverity: 4,
    description: 'Резкий дефицит топлива и электроэнергии.',
    effects: { economy: -20, discontent: 18, stability: -12 },
    randomVariance: 6,
    isPublic: true,
    flavorText: 'Очереди на заправках и веерные отключения.'
  },
  {
    id: 'opposition_unity',
    name: 'Объединение оппозиции',
    category: 'political',
    baseSeverity: 4,
    description: 'Главные оппозиционные силы создали единый фронт.',
    effects: { legitimacy: -18, stability: -10, discontent: 15 },
    randomVariance: 5,
    isPublic: true,
    flavorText: 'Оппозиция объявила о создании коалиции.'
  },
  {
    id: 'international_recognition',
    name: 'Международное признание',
    category: 'international',
    baseSeverity: 2,
    description: 'Ведущие страны выразили поддержку текущему режиму.',
    effects: { internationalImage: 20, externalPressure: -15 },
    randomVariance: 4,
    isPublic: true,
    flavorText: 'Дипломатическая победа правительства.'
  },
  {
    id: 'cyber_attack',
    name: 'Кибератака на госструктуры',
    category: 'security',
    baseSeverity: 4,
    description: 'Масштабная кибератака парализовала работу министерств.',
    effects: { stability: -15, fear: 16, economy: -10 },
    randomVariance: 5,
    isPublic: true,
    flavorText: 'Сайты госорганов недоступны.'
  },
  {
    id: 'cultural_renaissance',
    name: 'Культурный подъём',
    category: 'ideology',
    baseSeverity: 2,
    description: 'Всплеск патриотизма и культурной активности.',
    effects: { stability: 12, legitimacy: 10, radicalization: -8 },
    randomVariance: 4,
    isPublic: true,
    flavorText: 'Национальные фестивали и рост интереса к традициям.'
  }
  // Всего 42 события — файл полный
];
